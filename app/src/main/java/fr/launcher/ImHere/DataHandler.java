...
import fr.launcher.ImHere.dataprovider.IProvider;
...
import fr.launcher.ImHere.db.ShortcutRecord;
import fr.launcher.ImHere.db.ValuedHistoryRecord;
import fr.launcher.ImHere.pojo.Pojo;
import fr.launcher.ImHere.pojo.PojoComparator;
...
public class DataHandler extends BroadcastReceiver
    ...
    protected Intent providerName2Intent(String name) {
        ...
        className.append("fr.launcher.ImHere.dataprovider.");
