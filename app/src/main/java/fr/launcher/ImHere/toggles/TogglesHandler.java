package fr.launcher.ImHere.toggles;
...
public class TogglesHandler {
    ...
    private Boolean getTorchState() {
        return ImHereApplication.getCameraHandler().isTorchAvailable() && ImHereApplication.getCameraHandler().getTorchState();
    }

    private void setTorchState(Boolean state) {
        if(ImHereApplication.getCameraHandler().isTorchAvailable()) {
            ImHereApplication.getCameraHandler().setTorchState(state);
        }
    }
