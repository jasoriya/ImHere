...
public interface IProvider {
     ...
     *
     * `"fr.launcher.summon.LOAD_OVER"` will be emitted once the reload is complete. The data provider
     ...
     * `"fr.launcher.summon.LOAD_OVER"` intent for notification of when the provider is ready.
     *
