...
import fr.launcher.ImHere.db.DBHelper;
...
public abstract class Result {
    ...
    private void launchAddToFavorites(Context context, Pojo app) {
        ...
        ImHereApplication.getDataHandler(context).addToFavorites((MainActivity) context, app.id);
    ...
    private void launchRemoveFromFavorites(Context context, Pojo app) {
        ...
        ImHereApplication.getDataHandler(context).removeFromFavorites((MainActivity) context, app.id);
        Toast.makeText(context, String.format(msg, app.name), Toast.LENGTH_SHORT).show();
    }
    ...
    void recordLaunch(Context context) {
        // Save in history
        ImHereApplication.getDataHandler(context).addToHistory(pojo.id);
    }
