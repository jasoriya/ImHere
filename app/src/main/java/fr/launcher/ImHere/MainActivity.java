...
import fr.launcher.ImHere.adapter.RecordAdapter;
import fr.launcher.ImHere.broadcast.IncomingCallHandler;
import fr.launcher.ImHere.broadcast.IncomingSmsHandler;
...
import fr.launcher.ImHere.searcher.ApplicationsSearcher;
import fr.launcher.ImHere.searcher.HistorySearcher;
import fr.launcher.ImHere.searcher.NullSearcher;
import fr.launcher.ImHere.searcher.QueryInterface;
import fr.launcher.ImHere.searcher.QuerySearcher;
import fr.launcher.ImHere.searcher.Searcher;
import fr.launcher.ImHere.ui.BlockableListView;
import fr.launcher.ImHere.ui.BottomPullEffectView;
import fr.launcher.ImHere.ui.KeyboardScrollHider;
import fr.launcher.ImHere.utils.PackageManagerUtils;

public class MainActivity extends Activity implements QueryInterface, KeyboardScrollHider.KeyboardHandler {

    public static final String START_LOAD = "fr.Launcher.summon.START_LOAD";
    public static final String LOAD_OVER = "fr.Launcher.summon.LOAD_OVER";
    public static final String FULL_LOAD_OVER = "fr.Launcher.summon.FULL_LOAD_OVER";
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ImHereApplication.initDataHandler(this);
    ...
    public void onFilter(View v) {
        Intent intent = new Intent(MainActivity.this, DrawOverAppService.class);
        startService(intent);
    }
    ...
    protected void onResume() {
        ...
        AppProvider appProvider = ImHereApplication.getDataHandler(this).getAppProvider();
    ...
    protected void onDestroy() {
        ...
        ImHereApplication.getCameraHandler().releaseCamera();
    }
    ...
    public void onMenuButtonClicked(View menuButton) {
        // When the ImHere bar is displayed, the button can still be clicked in a few areas (due to favorite margin)
    ...
    public void onLauncherButtonClicked(View launcherButton) {
        // Display or hide the ImHere bar, according to current view tag (showMenu / hideMenu).
    ...
    public void onFavoriteButtonClicked(View favorite) {
        ...
        ArrayList<Pojo> favorites = ImHereApplication.getDataHandler(MainActivity.this).getFavorites(tryToRetrieve);
    ...
    private void displayKissBar(Boolean display) {
        ...
        // Hide the favorite bar in the ImHere bar if the quick bar is enabled
    ...
    public void displayFavorites() {
        ...
        ArrayList<Pojo> favoritesPojo = ImHereApplication.getDataHandler(MainActivity.this)
